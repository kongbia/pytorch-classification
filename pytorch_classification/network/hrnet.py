...
__all__ = ['HRNet', 'hrnet18', 'hrnet32', 'hrnet40']
...
def get_config(base_channel):
    cfg=dict(
        ...
        STAGE2=dict(
            ...
            BLOCK='BASIC',
            NUM_BLOCKS=(4, 4),
            NUM_CHANNELS=(base_channel, base_channel*2)),
        STAGE3=dict(
            NUM_MODULES=4,
            NUM_BRANCHES=3,
            BLOCK='BASIC',
            NUM_BLOCKS=(4, 4, 4),
            NUM_CHANNELS=(base_channel, base_channel*2, base_channel*4)),
        STAGE4=dict(
            NUM_MODULES=3,
            NUM_BRANCHES=4,
            BLOCK='BASIC',
